...
const pageMeta = computed(() => ({
  ...
  '/graph': ['知识地图', '把大纲、薄弱点和训练串成一张图'], '/knowledge': ['知识点库', '维护章-节-知识点层级与属性'], '/practice': ['综合练习', '选择一个知识点，完成一段刻意训练'], '/case': ['案例工作台', '拆题、列要点、复盘得分证据'],
...
const groups = [
  ...
  { label: '学习与训练', items: [['/graph', 'network', '知识地图'], ['/knowledge', 'library', '知识点库'], ['/practice', 'book', '综合练习'], ['/case', 'case', '案例工作台'], ['/essay', 'essay', '论文工作台'], ['/exam', 'exam', '模拟考试']] },

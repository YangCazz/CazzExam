    ...
    <div class="week-grid">
      ...
      <div class="week-summary">
        ...
        <template v-if="weak.length">
          <p class="eyebrow week-sub">待加强</p>
        ...
        <BaseButton :to="'/insights'" variant="ghost" class="week-link">查看完整能力画像<Icon name="arrow-right" :size="14" /></BaseButton>
      </div>
    </div>
  </section>
</template>
...
.week-sub { margin-top: 20px; }
.week-link { margin-top: 18px; display: inline-flex; }
